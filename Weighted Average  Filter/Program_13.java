...
import java.lang.*;
public class Program_13 implements PlugInFilter {
	ImagePlus imp;
	...
	public void run(ImageProcessor orig) {
		...
		ImagePlus outputImp = NewImage.createByteImage	("Weighted Filtered Image", w, h, 1, NewImage.FILL_BLACK);
