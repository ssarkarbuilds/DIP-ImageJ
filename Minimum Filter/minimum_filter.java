...
public class minimum_filter implements PlugInFilter {
	ImagePlus imp;
	...
	ImagePlus outputImp = NewImage.createByteImage("Minimum Filter Image", w, h, 1, NewImage.FILL_BLACK);
